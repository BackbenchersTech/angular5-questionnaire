...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__questions_group_questions_group_component__ = __webpack_require__("./src/app/admin/questions-group/questions-group.component.ts");
...
var routes = [
    ...
    {
        path: 'questions',
        component: __WEBPACK_IMPORTED_MODULE_3__questions_group_questions_group_component__["a" /* QuestionsGroupComponent */]
    },
    {
        path: '**',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__questions_group_questions_group_component__ = __webpack_require__("./src/app/admin/questions-group/questions-group.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__keys_pipe__ = __webpack_require__("./src/app/admin/keys.pipe.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AdminModule = /** @class */ (function () {
    ...
    AdminModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_4__dashboard_dashboard_component__["a" /* DashboardComponent */], __WEBPACK_IMPORTED_MODULE_7__questions_group_questions_group_component__["a" /* QuestionsGroupComponent */], __WEBPACK_IMPORTED_MODULE_8__keys_pipe__["a" /* KeysPipe */]],
...
var __metadata = (this && this.__metadata) || function (k, v) {
 ...
 // import headers for post requests (as in surveyservice)
...
var AdminService = /** @class */ (function () {
    function AdminService(http, sqs) {
        this.http = http;
        this.sqs = sqs;
        this.answers = {};
    }
    AdminService.prototype.getUsersAndSurvey = function () {
        return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].forkJoin(this.http.get('https://angular5-questionnaire.herokuapp.com/api/users'), this.http.get('https://angular5-questionnaire.herokuapp.com/api/data'));
    };
    AdminService.prototype.getSurvey = function () {
        return this.http.get('https://angular5-questionnaire.herokuapp.com/api/data');
    };
    AdminService.prototype.formAnswersObject = function () {
        var sQues = this.sqs.questions.pages;
        for (var i = 0; i < sQues.length; i++) {
            var page = sQues[i];
            for (var j = 0; j < page.elements.length; j++) {
                var question = page.elements[j].name;
                if (page.elements[j]['choices'] !== undefined) {
                    var qChoices = page.elements[j]['choices'];
                    var choices = {};
                    for (var c in qChoices) {
    ...
    AdminService.prototype.countSurveys = function (surveysData) {
        for (var i = 0; i < surveysData.surveys.length; i++) {
            var survey = surveysData.surveys[i].surveyData;
            for (var q in survey) {
                if (this.answers[q] !== undefined) {
                    if (this.answers[q].statBased) {
                        if (typeof survey[q] === "object") {
                            for (var c = 0; c < survey[q].length; c++) {
    ...
    AdminService = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */],
            __WEBPACK_IMPORTED_MODULE_4__survey_questions__["a" /* SurveyQuestions */]])
    ], AdminService);
    return AdminService;
}());
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(adminService, router) {
    ...
    DashboardComponent.prototype.showResults = function () {
        this.router.navigate(['admin', 'questions']);
    };
    DashboardComponent.prototype.getData = function () {
        var _this = this;
        this.adminService.formAnswersObject();
        this.adminService.getUsersAndSurvey().subscribe(function (data) {
            _this.usersData = data[0];
            _this.surveysData = data[1];
            var a = _this.surveysData.surveys;
            for (var i = 0; i < a.length; i++) {
                a[i].surveyData.userId = a[i].userId;
                a[i] = a[i].surveyData;
            }
            _this.result = _this.usersData.users.map(function (val) {
                return Object.assign({}, val, a.filter(function (v) { return v.userId === val._id; })[0]);
            });
            ...
            _this.colHeaders = Object.keys(_this.columnNames);
        }, function (err) {
            console.log(err);
        }, function () {
            _this.adminService.countSurveys(_this.surveysData);
            _this.surveysData = _this.adminService.getData();
        });
    };
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__admin_service__["a" /* AdminService */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */]])
    ], DashboardComponent);
...
/***/ "./src/app/admin/questions-group/questions-group.component.css":
/***/ (function(module, exports) {

module.exports = ".questionsCard {\r\n    padding: 10px 15px 10px 15px;\r\n    margin: 15px 10px 10px 10px;\r\n    -webkit-box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 1px 5px 0 rgba(0, 0, 0, 0.12);\r\n            box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 1px 5px 0 rgba(0, 0, 0, 0.12);\r\n    border-radius: 2px;\r\n}\r\n\r\n.questionsCard .question {\r\n    font-weight: bold;\r\n}\r\n\r\n.questionsCard .showLess {\r\n    padding: 10px;\r\n}\r\n\r\n.questionsCard .showLess a {\r\n    color: #3b6caa;\r\n    font-weight: bold;\r\n    cursor: pointer;\r\n}\r\n\r\n.stats ul {\r\n    list-style: none;\r\n    padding: 0px;\r\n}\r\n\r\n.stats ul>li {\r\n    padding: 5px;\r\n    margin: 10px 0px;\r\n    line-height: 28px;\r\n    border:1px solid #3b6caa;\r\n    padding: 0px 10px;\r\n    background-color: #fff;\r\n    color:#3b6caa;\r\n    border-radius:20px;\r\n    -webkit-box-shadow: inset 0 0 8px #3b6caa;\r\n            box-shadow: inset 0 0 8px #3b6caa;\r\n    padding-right: 0px;\r\n}\r\n\r\n.stats ul>li .answerKey {\r\n    display: -webkit-inline-box;\r\n    display: -ms-inline-flexbox;\r\n    display: inline-flex;\r\n    line-height: 40px;\r\n\r\n}\r\n\r\n.stats ul>li .answerValue {\r\n    display: inline;\r\n    float: right;\r\n    padding-left: 15px;\r\n    width: 40px;\r\n    border: 1px solid #fff;\r\n    border-radius:20px;\r\n    line-height: 38px;\r\n    background-color: #3b6caa;\r\n    -webkit-box-shadow: 0px 0px 8px 2px #3b6caa;\r\n            box-shadow: 0px 0px 8px 2px #3b6caa;\r\n    color:#fff;\r\n}\r\n\r\n.viewTableBtn{\r\n    background-color: #3b6caa;\r\n    color: white;\r\n    margin-left: 10px;\r\n}\r\n\r\ncanvas {\r\n    margin: 0 auto;\r\n}\r\n\r\n.resultsWrap {\r\n    width: 80%;\r\n    margin: 0 auto;\r\n    padding-top: 25px;\r\n}\r\n\r\n@media screen and (min-width:768px) {\r\n    .buttonWrap {\r\n        display: none;\r\n    }\r\n}\r\n\r\n@media screen and (max-width:767px) {\r\n    .resultsWrap {\r\n        width: 90%;\r\n        margin: 0 auto;\r\n    }\r\n}\r\n\r\n.showChartBtn {\r\n    background-color: #3b6caa;\r\n    color: white;\r\n}"

/***/ }),

/***/ "./src/app/admin/questions-group/questions-group.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"resultsWrap\">\r\n    <button type=\"button\" class=\"btn viewTableBtn\" (click)=\"showTable()\">View Results Table</button>\r\n    <div class=\"row\">\r\n        <div *ngFor=\"let question of questions; let i = index;\" class=\"col-sm-12\">\r\n            <div class=\"questionsCard row \">\r\n                <div class=\"col-md-6 col-12\">\r\n                    <div class=\"question\">\r\n                        {{question}}\r\n                    </div>\r\n                    <div class=\"stats\">\r\n                        <ul>\r\n                            <li *ngFor=\"let choice of answersData[question] | keys\">\r\n                                <div class=\"answerKey\">{{choice.key }}</div>\r\n                                <div class=\"answerValue\">{{ choice.value}}</div>\r\n                            </li>\r\n                        </ul>\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-sm-6 col-12\" [hidden]=\"!answersData[question].statBased\">\r\n                    <div [hidden]=\"!canvasVisibility['canvas' + i]\" class=\"canvasWrap\">\r\n                        <canvas #parent id=\"{{'canvas' + i}}\" width=\"300\" height=\"300\"></canvas>\r\n                    </div>\r\n                    <div class=\"buttonWrap\">\r\n                        <div class=\"text-center displayBtn\" [hidden]=\"this.submitted['canvas' + i]\">\r\n                            <button class=\"btn showChartBtn\" (click)=\"showChart(i)\">\r\n                        <i class=\"fas fa-chart-pie\"></i>Display Charts\r\n                        </button>\r\n                        </div>\r\n                        <div class=\"text-center showLess\" [hidden]=\"!this.submitted['canvas' + i]\">\r\n                            <a (click)=\"showLess(i)\">Show Less <i class=\"fa fa-angle-double-up\"></i></a>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>"

/***/ }),

/***/ "./src/app/admin/questions-group/questions-group.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return QuestionsGroupComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
var QuestionsGroupComponent = /** @class */ (function () {
    function QuestionsGroupComponent(adminService, elementRef, router) {
        this.adminService = adminService;
    ...
    QuestionsGroupComponent.prototype.onResize = function (event) {
    ...
    QuestionsGroupComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.getAnswersDataData();
        this.canvases.changes.subscribe(function () {
            _this.makeCharts(_this.canvases.toArray());
        });
    };
    QuestionsGroupComponent.prototype.ngOnChanges = function () {
        // console.log("hey")
    };
    QuestionsGroupComponent.prototype.getAnswersDataData = function () {
        var _this = this;
        ...
        this.adminService.getSurvey().subscribe(function (data) {
            _this.adminService.countSurveys(data);
        }, function (err) {
            console.log(err);
        }, function () {
            _this.questions = Object.keys(_this.answersData);
        });
    };
    QuestionsGroupComponent.prototype.showTable = function () {
        this.router.navigate(['admin', 'dashboard']);
    };
    QuestionsGroupComponent.prototype.showLess = function (i) {
        this.submitted["canvas" + i] = false;
        this.canvasVisibility["canvas" + i] = false;
    };
    QuestionsGroupComponent.prototype.showChart = function (i) {
        this.submitted["canvas" + i] = true;
        this.canvasVisibility["canvas" + i] = true;
    };
    QuestionsGroupComponent.prototype.makeCharts = function (canvases) {
        for (var i = 0; i < this.questions.length; i++) {
            ...
            if (!this.answersData[question].statBased) {
                ...
                var answer = this.answersData[question];
                var a = Object.assign({}, answer);
                delete a.statBased;
                var colors = this.getColors(Object.keys(a).length);
                var ctx = canvases[i].nativeElement;
    ...
    QuestionsGroupComponent.prototype.getColors = function (number) {
        var lights = ['#FF8A65', '#90A4AE', '#FFF176', '#81C784', '#4FC3F7', '#9575CD', '#7986CB', '#F06292', '#AED581', '#FFB74D', '#A1887F', '#E0E0E0'];
        return lights.splice(0, number + 1);
    };
    QuestionsGroupComponent.prototype.showAllCharts = function () {
        for (var i in this.canvasVisibility) {
            this.canvasVisibility[i] = true;
            this.submitted[i] = false;
        }
    };
    QuestionsGroupComponent.prototype.hideAllCharts = function () {
        for (var i in this.canvasVisibility) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewChildren */])('parent'),
        __metadata("design:type", Object)
    ], QuestionsGroupComponent.prototype, "canvases", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* HostListener */])('window:resize', ['$event']),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object]),
        __metadata("design:returntype", void 0)
    ], QuestionsGroupComponent.prototype, "onResize", null);
    QuestionsGroupComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-questions-group',
            template: __webpack_require__("./src/app/admin/questions-group/questions-group.component.html"),
            styles: [__webpack_require__("./src/app/admin/questions-group/questions-group.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__admin_service__["a" /* AdminService */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */]])
    ], QuestionsGroupComponent);
    return QuestionsGroupComponent;
}());
